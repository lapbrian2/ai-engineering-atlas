...
const topics = [
  { num: '01', title: 'Understanding', em: 'Foundation Models', slug: 'foundation-models',
    ...
    prims: ['Tokenizer', 'Attention heatmap', 'Temperature slider'], hero: true, time: '28 min read' },
  { num: '02', title: 'Prompt', em: 'Engineering', slug: 'prompt-engineering',
    ...
    prims: ['Prompt diff', 'CoT stepper'], hero: true, time: '22 min read' },
  { num: '03', title: 'Evaluation', em: '', slug: 'evaluation',
    ...
    prims: ['Metric calculator', 'Judge comparator'], hero: false, time: '26 min read' },
  { num: '04', title: 'RAG &', em: 'Agents', slug: 'rag-agents',
    ...
    prims: ['Vector search', 'Agent loop', 'Tool tracer'], hero: true, time: '34 min read' },
  { num: '05', title: 'Finetuning', em: '', slug: 'finetuning',
    ...
    prims: ['Memory calc', 'LoRA rank viz'], hero: false, time: '30 min read' },
  { num: '06', title: 'Dataset', em: 'Engineering', slug: 'dataset-engineering',
    ...
    prims: ['Quality scorer', 'Synthesis demo'], hero: false, time: '24 min read' },
  { num: '07', title: 'Inference', em: 'Optimization', slug: 'inference-optimization',
    ...
    prims: ['Pareto chart', 'Quantization calc'], hero: false, time: '28 min read' },
  { num: '08', title: 'System', em: 'Architecture', slug: 'system-architecture',
    ...
    prims: ['System diagram'], hero: false, time: '22 min read' },
  { num: '09', title: 'User', em: 'Feedback', slug: 'user-feedback',
    ...
    prims: ['Pattern explorer'], hero: false, time: '18 min read' },
  { num: '10', title: 'Production &', em: 'Cost', slug: 'production-cost',
    ...
    prims: ['Cost calc', 'Rollout planner'], hero: false, time: '26 min read' }
]
</script>
